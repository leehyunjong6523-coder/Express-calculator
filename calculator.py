    14.5:[43410, 47963, 61545, 106551, 116855, 119053, 144132, 190072, 204376, 28982],
    15.0:[44146, 48763, 62460, 108756, 119242, 121523, 147973, 194598, 209662, 29443],
    15.5:[44897, 48875, 62610, 109604, 121520, 124101, 149517, 199806, 215879, 29923],
    16.0:[45648, 49063, 62790, 110600, 123777, 126589, 150965, 204939, 222057, 30451],
    16.5:[46329, 49250, 62895, 111660, 126077, 130276, 152547, 210110, 228175, 30922],
    17.0:[47065, 49363, 63060, 112593, 128421, 134125, 154033, 215262, 234373, 31421],
    17.5:[47816, 49538, 63270, 113441, 130786, 137239, 155500, 220414, 240431, 31910],
    18.0:[48414, 49675, 63315, 114374, 132457, 141070, 158492, 223670, 243956, 32266],
    18.5:[48928, 49825, 63375, 115264, 134193, 144650, 161502, 226854, 247559, 32611],
    19.0:[49442, 50000, 63510, 116134, 137296, 148284, 165691, 230037, 250628, 32976],
    19.5:[50471, 50138, 63615, 116939, 139791, 152043, 169859, 233754, 253678, 33811],
    20.0:[51708, 50350, 63780, 118275, 143220, 155748, 174028, 239715, 257638, 34637],
}
UPS_NET_DOC = {
...
# ── UPS 2F94A8 별도 국가 원가 (싱가포르/일본/인도네시아/홍콩) — 2026-05-06 ──
UPS_NET_SGP_PKG = {
    0.5:14225,
    1.0:14225,
    1.5:14225,
...
UPS_NET_OVER = {
    44:[2585, 2500, 3150, 5894, 7576, 8004, 9115, 12632, 14460, 1728],    # ~44kg
    70:[2585, 2500, 3150, 5894, 7576, 8004, 9115, 12632, 14460, 1728],    # ~70kg
    99:[2584, 2516, 3045, 5897, 7473, 7572, 8973, 12514, 14346, 1707],    # ~99kg
    299:[2584, 2516, 3045, 5897, 7473, 7572, 8973, 12514, 14346, 1707],    # ~299kg
    499:[2591, 2491, 2910, 5883, 7417, 7518, 8790, 12197, 14006, 1716],    # ~499kg
    999:[2591, 2491, 2910, 5883, 7417, 7518, 8790, 12197, 14006, 1716],    # ~999kg
    9999999:[2591, 2491, 2910, 5883, 7417, 7518, 8790, 12197, 14006, 1716],
}
...
def ups_lookup(w, zi, is_doc, acct="2F94A8", dest_country=""):
    ...
    rpk = None
    # ── 별도 국가 원가 테이블 (2F94A8만 해당) ──
    _SPECIAL_NET_PKG = {
        "Singapore":       UPS_NET_SGP_PKG,
        "Japan":           UPS_NET_JPN_PKG,
        "Indonesia":       UPS_NET_IDN_PKG,
        "Hong Kong SAR China": UPS_NET_HKG_PKG,
    }
    ...
    if w <= 20:
        ...
        pub = ceil10(rpk * rw)
        if _special_tbl:
            net_per_kg = _special_tbl.get(br, 0)
            net = ceil10(net_per_kg * rw)
        else:
            ac = UPS_ACCOUNTS[acct]
